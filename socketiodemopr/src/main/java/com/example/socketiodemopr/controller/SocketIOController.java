package com.example.socketiodemopr.controller;
...
import com.example.socketiodemopr.data.Message;
...
public class SocketIOController {
    ...
    public DataListener<Message> onSendMessage = new DataListener<Message>() {
        @Override
        public void onData(SocketIOClient client, Message message, AckRequest acknowledge) {
